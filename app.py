...
if 'RAILWAY_ENVIRONMENT' in os.environ or 'RAILWAY_STATIC_URL' in os.environ:
    ...
    # Ya phir /tmp directory use karo
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;font-family:'Segoe UI',sans-serif;}
        ...
        .logout{float:right;color:white;text-decoration:none;padding:5px 15px;background:rgba(255,255,255,0.2);border-radius:20px;}
    </style>
</head>
<body>
    <div class="navbar">
        <h2 style="display:inline-block;">📊 HTML Render Pro</h2>
        <a href="/logout" class="logout">🚪 Logout</a>
    </div>
    
    <div class="container">
        <div style="margin-bottom:1rem;">
            <span class="tab active" onclick="showTab('dashboard')" id="tab-dashboard">🏠 Dashboard</span>
            <span class="tab" onclick="showTab('render')" id="tab-render">📄 Render HTML</span>
            <span class="tab" onclick="showTab('url')" id="tab-url">🌐 Render URL</span>
            <span class="tab" onclick="showTab('history')" id="tab-history">📜 History</span>
        </div>
